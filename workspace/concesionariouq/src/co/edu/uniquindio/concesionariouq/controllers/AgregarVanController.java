...
public class AgregarVanController {
	...
	void agregarAction(ActionEvent event) {
		try {
			...
			ModelFactoryController.getInstance().agregarVehiculo(new Van(txtPlaca.getText().trim(),
					...
					Double.parseDouble(txtCapacidadMaletero.getText()), imagen));
			actualizarTabla.run();
	...
	public AgregarVanController(Combustible combustible, Runnable actualizarTabla) {
