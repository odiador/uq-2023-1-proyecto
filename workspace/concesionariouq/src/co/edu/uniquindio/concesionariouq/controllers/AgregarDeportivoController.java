...
public class AgregarDeportivoController {
	...
	public AgregarDeportivoController(Combustible combustible, Runnable actualizarTabla) {
	...
	void agregarAction(ActionEvent event) {
		try {
			Image imagen = new Image("/resources/images/vehiculos/deportivo.png");
			ModelFactoryController.getInstance()
					.agregarVehiculo(new Deportivo(txtPlaca.getText().trim(), txtMarca.getText().trim(),
							...
							Integer.parseInt(txtNumBolsas.getText()), Integer.parseInt(txtNumPuertas.getText()), 100,
							Double.parseDouble(txtTiempo100km.getText().trim()), imagen));
			actualizarTabla.run();
